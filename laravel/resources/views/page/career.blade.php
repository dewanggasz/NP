    ...
    <main class="main-content main-container">
            ...
            <div class="career-page-cover__wrapper">
                ...
                <div class="career-page-cover__content">
                    <div class="career-page-cover__overlay-top">
                        ...
                        <h2 class="career-page-cover__head">Empower, Solve, and Grow with NPS.</h2>
        ...
        <section class="overview">
            <div class="overview__wrapper">
                <div class="overview__top">
                    ...
                    <h2 class="overview-header">PT Nata Praja Solusindo thrives on the strength of its people and the value of their expertise.</h2>
                    <div class="overview-paragraph">
                        <p>We believe that strong teams are built by exceptional individuals. At PT Nata Praja Solusindo, we are committed to hiring the best talent and empowering them to reach their full potential.</p>
                        <p>This philosophy is reflected in our core values: Collaboration, Dedication, Integrity, and Innovation.</p>
                        <p>Our team members are encouraged to share their opinions, have their voices heard, and make meaningful contributions. We foster long-term relationships with clients while creating a workplace that rewards hard work, promotes teamwork, and provides opportunities for personal and professional growth.</p>
                    </div>
                </div>
            ...
            <div class="accordion">
                <div class="accordion-item active">
                    ...
                    <div class="accordion-content">
                        <p>
                            At PT Nata Praja Solusindo, we believe that teamwork and dedication drive success. That’s why we offer competitive salaries, performance-based incentives, and rewards that reflect your hard work and contributions to the team.
                        </p>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <p>
                            Your well-being is our priority. We provide comprehensive health benefits, including BPJS, insurance, and wellness programs. Our initiatives are designed to support your physical and mental health, ensuring a balanced and fulfilling work-life experience.
                        </p>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <p>
                            Our headquarters in Sleman, Yogyakarta, is equipped with state-of-the-art facilities, including spacious workstations, ergonomic seating, and dedicated training rooms. With a focus on comfort and functionality, we create a workplace where productivity and collaboration thrive.
                        </p>
                    </div>
                </div>
            </div>              
        ...
        <section class="hiring">
            <div class="hiring__wrapper">
                <div class="hiring__heading">
                    <div class="sub-title">Company Hiring</div>
                    <h2 class="hiring__heading-title">We're Looking For</h2>
                </div>
                <div class="hiring__content">
                    @foreach ($jobs as $job)
                        <a href="{{ route('karir.show', ['slug' => $job->slug]) }}" class="hiring__card">
                            <div class="hiring__card-overlay"></div>
                            <div class="hiring__card-top">
                                <div class="hiring__card-top-left">
                                    <h2 class="hiring__card-role">{{ $job->role }}</h2>
                                    <p>{{ $job->location }}</p>
                                </div>
                                <div class="hiring__card-top-right">
                                    <h5 class="hiring__card-time">{{ $job->type }}</h5>
                                </div>
                            </div>
                            <div class="hiring__card-bot">
                                <h4>View & Apply</h4>
                            </div>
                        </a>
                    @endforeach
