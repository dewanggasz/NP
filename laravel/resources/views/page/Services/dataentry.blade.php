...
<head>
    ...
    <title>Nata Praja - Data Entry</title>
        ...
        <nav class="navbig">
            <div class="navbig__wrapper flxcenter-vertical-spcbtwn">
                ...
                <ul class="navbig-center nav-list flxcenter-vertical-spcbtwn" style="color: rgb(15, 41, 22);">
                    ...
                    <li class="dropdown">
                        <a href="#" class="horizontal-slide" data-replace="Insight"><span>Insight</span></a>
                        <ul class="dropdown-menu">
                            <li><a href="{{ route('artikel') }}">Artikel</a></li>
                            <li><a href="{{ route('gallery') }}">Gallery</a></li> <!-- Ganti dengan route yang sesuai -->
                        </ul>
                    </li>
    ...
    <!-- breadcrumb -->
     <div class="breadcrumb">
        <div class="breadcrumb__wrapper">
            ...
            <div class="breadcrumb__icon2">></div>
            <div class="breadcrumb__info">
                <a href="{{route('dataentry')}}">Data Entry</a>
            </div>
        </div>
     </div>
    <!-- breadcrumb -->
     ...
     <main class="main-content main-container our-service-container">
        ...
        <section id="scrolltop" class="page-cover">
            <div class="page-cover__wrapper">
                <img src="{{asset('resources/img/services/3.jpg')}}" alt="" class="page-cover-img" loading="lazy">
                <div class="page-cover__overlay">
                    ...
                    <a href="#serviceFeatures" class="page-cover__overlay-bot scroll-link">
                        <h2>Introduction to Data Entry Service</h2>
            ...
            <section class="ourstory">
                <div class="ourstory__wrapper">
                    <div class="ourstory__top">
                        <div class="sub-title">Data Entry</div>
                        <h2 class="ourstory-header">Streamlining Business Operations with Accurate and Efficient Data Entry Solutions</h2>
                        <div class="ourstory-paragraph">
                            <p>At PT Nata Praja Solusindo, our Data Entry service is designed to enhance operational efficiency by ensuring the accuracy and reliability of your business data. From administrative tasks to industry-specific data management, our professional team is equipped to handle high-volume and complex data processes with precision.</p>
                            <p>By utilizing advanced tools and adhering to strict quality standards, we help businesses maintain organized and accessible information crucial for decision-making and workflow optimization. Our tailored approach ensures that every client's unique requirements are met, allowing them to focus on core business growth while we manage the details.</p>
                            <p>Whether you need consistent data updates, meticulous verification, or custom formatting, our Data Entry service guarantees dependable results that empower your organization to stay ahead in a competitive market.</p>
                        </div>
                    </div>
                    <div class="ourstory__bottom">
                        <div class="ourstory__bottom-img-wrapper">
                            <img src="{{asset('resources/img/landingPage/Services/dataEntry.jpg')}}" alt="" loading="lazy">
                        </div>
                    </div>
                </div>
            </section>
        ...
        <section id="serviceFeatures" class="our-value">
            <div class="our-value__heading">
                <div class="our-value-heading-items">
                    ...
                    <h2>Nata Praja<br>Data Entry<br>Service</h2>
                </div>
            </div>
            <div class="accordion">
                <div class="accordion-item active">
                    <div class="accordion-header" onclick="toggleAccordion(this)">
                        <h3>Key Features of Our Data Entry Service</h3>
                        <span class="arrow"></span>
                    </div>
                    <div class="accordion-content">
                        <ol>
                            <li><strong>Accurate Data Processing:</strong> Ensuring every piece of information is meticulously entered and verified for reliability and precision.</li>
                            <li><strong>High-Volume Capacity:</strong> Efficiently managing large data sets with minimal errors, regardless of industry or complexity.</li>
                            <li><strong>Customizable Formats:</strong> Tailoring data entry processes to match your specific requirements and system compatibility.</li>
                            <li><strong>Secure Data Management:</strong> Utilizing advanced security protocols to protect sensitive information and ensure data confidentiality.</li>
                        </ol>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <ol>
                            <li><strong>Experienced Professionals:</strong> Our team is skilled in managing data entry projects with accuracy and speed, minimizing human errors.</li>
                            <li><strong>Cutting-Edge Tools:</strong> We leverage the latest technologies to streamline data entry workflows, ensuring timely delivery and quality results.</li>
                            <li><strong>Data Security Compliance:</strong> Adhering to ISO 27001:2013 standards, we guarantee the safety and integrity of your data.</li>
                        </ol>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <ol>
                            <li><strong>Database Updates:</strong> Regularly update customer, vendor, or internal records to maintain accurate and up-to-date information.</li>
                            <li><strong>Document Digitization:</strong> Convert physical documents into digital formats for easier access and archiving.</li>
                            <li><strong>Financial Data Management:</strong> Accurately input and verify financial data, such as invoices, transactions, or expense reports.</li>
                            <li><strong>Market Research Support:</strong> Input survey responses and market data for analysis and insights.</li>
                        </ol>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <ol>
                            <li><strong>Operational Efficiency:</strong> Free up your internal resources by outsourcing repetitive data entry tasks to our expert team.</li>
                            <li><strong>Informed Decision-Making:</strong> Ensure accurate and organized data that supports better strategic planning and analysis.</li>
                            <li><strong>Cost-Effectiveness:</strong> Reduce operational costs while maintaining a high standard of quality and precision.</li>
                        </ol>
                    </div>
                </div>
            </div>
