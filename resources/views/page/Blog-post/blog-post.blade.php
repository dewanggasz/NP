...
<body style="overflow-x: hidden;">
    ...
    <!-- Article Content -->
     <section id="articlePage" class="articlePage">
        <div class="articlePage__cover">
            <div class="articlePage__coverinfo">
                <h1>{{ $article->title }}</h1>
                <p>{{ $article->excerpt }}</p>
                <a class="articlePage__coverinfobutton" href="#articleContent"><i class="fa-solid fa-arrow-down-long" style="color: #ffffff;"></i></a>
            </div>
            <div class="articlePage__coveroverlay"></div>
            <img class="articlePage__coverimg" src="{{ asset('storage/' . $article->thumbnail) }}" alt="{{ $article->title }}">
        </div>
        <section class="articlePage__container">
            <div class="articlePage__info">
                <div class="articlePage__infowrapper">
                    <div class="articlePage__infowrapperleft">
                        <p class="articlePage__infowrapperdate">{{ $article->published_at }}</p>
                    </div>
                    <div class="articlePage__infowrapperright">
                        <a href="" class="articlePage__infowrapperrighticon"><i class="fa-brands fa-x-twitter"></i></a>
                        <a href="" class="articlePage__infowrapperrighticon"><i class="fa-brands fa-instagram"></i></a>
                        <a href="" class="articlePage__infowrapperrighticon"><i class="fa-brands fa-facebook-f"></i></a>
                        <a href="" class="articlePage__infowrapperrighticon"><i class="fa-brands fa-whatsapp"></i></a>
                    </div>
                </div>
            </div>
