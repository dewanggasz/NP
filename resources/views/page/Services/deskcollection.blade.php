...
<head>
    ...
    <title>Nata Praja - Desk Collection</title>
    ...
    <!-- breadcrumb -->
     <div class="breadcrumb">
        <div class="breadcrumb__wrapper">
            ...
            <div class="breadcrumb__icon2">></div>
            <div class="breadcrumb__info">
                <a href="{{route('deskcollection')}}">Desk Collection</a>
            </div>
        </div>
     </div>
    <!-- breadcrumb -->
     ...
     <main class="main-content main-container our-service-container">
        ...
        <section id="scrolltop" class="page-cover">
            <div class="page-cover__wrapper">
                <img src="{{asset('resources/img/services/5.jpg')}}" alt="" class="page-cover-img" loading="lazy">
                <div class="page-cover__overlay">
                    ...
                    <a href="#serviceFeatures" class="page-cover__overlay-bot scroll-link">
                        <h2>Introduction to Desk Collection Service</h2>
            ...
            <section class="ourstory">
                <div class="ourstory__wrapper">
                    <div class="ourstory__top">
                        <div class="sub-title">Desk Collection</div>
                        <h2 class="ourstory-header">Efficient Desk Collection Services to Manage Payments and Minimize Risks</h2>
                        <div class="ourstory-paragraph">
                            <p>PT Nata Praja Solusindo offers professional Desk Collection services to assist businesses in managing overdue payments and reducing financial risks. Our team of experts is trained to communicate effectively with customers, ensuring that outstanding payments are resolved through negotiation and strategic follow-ups.</p>
                            <p>With a focus on compliance and professionalism, we handle collections using ethical practices, respecting customer relationships while achieving your business objectives. From reminders to debt settlement, our tailored approach ensures efficiency, accuracy, and a positive customer experience. By outsourcing your desk collection needs to us, you can reduce operational burdens and maintain a healthy cash flow for your business.</p>
                        </div>
                    </div>
                    <div class="ourstory__bottom">
                        <div class="ourstory__bottom-img-wrapper">
                            <img src="{{asset('resources/img/landingPage/Services/deskCollection.jpg')}}" alt="" loading="lazy">
                        </div>
                    </div>
                </div>
            </section>
        ...
        <section id="serviceFeatures" class="our-value">
            <div class="our-value__heading">
                <div class="our-value-heading-items">
                    ...
                    <h2>Nata Praja<br>Desk Collection<br>Service</h2>
                </div>
            </div>
            <div class="accordion">
                <div class="accordion-item active">
                    <div class="accordion-header" onclick="toggleAccordion(this)">
                        <h3>Key Features of Our Desk Collection Service</h3>
                        <span class="arrow"></span>
                    </div>
                    <div class="accordion-content">
                        <ol>
                            <li><strong>Payment Reminders:</strong> Proactively remind customers of overdue payments through calls, emails, or letters.</li>
                            <li><strong>Negotiation Expertise:</strong> Skilled agents trained to negotiate payment terms and settlements effectively.</li>
                            <li><strong>Dispute Resolution:</strong> Address and resolve customer disputes to facilitate payment completion.</li>
                            <li><strong>Compliance & Ethics:</strong> Conducting telemarketing activities in accordance with industry regulations and ethical standards.</li>
                            <li><strong>Compliance with Regulations:</strong> Ensure all collection activities adhere to local laws and ethical standards.</li>
                        </ol>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <ol>
                            <li><strong>Trained Professionals:</strong> Our collection agents specialize in handling sensitive financial conversations with diplomacy and expertise.</li>
                            <li><strong>Customized Strategies:</strong> Tailored collection approaches based on client-specific needs and customer behavior analysis.</li>
                            <li><strong>Technology Integration:</strong> Utilize advanced CRM and data tools to track, analyze, and optimize the collection process.</li>
                            <li><strong>Compliance Assurance:</strong> Adhere to legal and ethical standards to protect your business reputation and avoid regulatory issues.</li>
                        </ol>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <ol>
                            <li><strong>Overdue Payment Reminders:</strong> Regularly follow up with customers to ensure timely payments.</li>
                            <li><strong>Debt Negotiations:</strong> Work with customers to create payment plans that suit both parties.</li>
                            <li><strong>Dispute Handling:</strong> Resolve billing disputes effectively to clear obstacles to payment.</li>
                            <li><strong>Final Payment Collection:</strong> Recover unpaid amounts from long-overdue accounts.</li>
                        </ol>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <ol>
                            <li><strong>Improved Sales Performance:</strong> Drive revenue growth through targeted telemarketing campaigns.</li>
                            <li><strong>Enhanced Customer Insights:</strong> Gain valuable feedback and data to refine your marketing strategies.</li>
                            <li><strong>Cost Efficiency:</strong> Outsource your telemarketing needs and reduce the cost of in-house operations.</li>
                        </ol>
                    </div>
                </div>
            </div>
