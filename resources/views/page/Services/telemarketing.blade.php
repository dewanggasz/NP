...
<head>
    ...
    <title>Nata Praja - Telemarketing</title>
    ...
    <!-- breadcrumb -->
     <div class="breadcrumb">
        <div class="breadcrumb__wrapper">
            ...
            <div class="breadcrumb__icon2">></div>
            <div class="breadcrumb__info">
                <a href="{{route('telemarketing')}}">Telemarketing</a>
            </div>
        </div>
     </div>
    <!-- breadcrumb -->
     ...
     <main class="main-content main-container our-service-container">
        <section id="scrolltop" class="page-cover">
            <div class="page-cover__wrapper">
                <img src="{{asset('resources/img/services/4.jpg')}}" alt="" class="page-cover-img" loading="lazy">
                <div class="page-cover__overlay">
                    ...
                    <a href="#serviceFeatures" class="page-cover__overlay-bot scroll-link">
                        <h2>Introduction to Telemarketing Service</h2>
            ...
            <section class="ourstory">
                <div class="ourstory__wrapper">
                    <div class="ourstory__top">
                        <div class="sub-title">Telemarketing</div>
                        <h2 class="ourstory-header">Boost Your Sales and Customer Engagement with Expert Telemarketing Services</h2>
                        <div class="ourstory-paragraph">
                            <p>PT Nata Praja Solusindo offers professional Telemarketing services designed to help businesses expand their market reach, increase sales, and strengthen customer relationships. Our telemarketing experts are highly trained to connect with your target audience, understand their needs, and present your products or services in a compelling manner.</p>
                            <p>Utilizing advanced communication tools and customer-focused strategies, we deliver personalized telemarketing campaigns that drive results. Whether you aim to generate leads, promote new products, or gather customer insights, our service ensures every call creates value for your business. By outsourcing your telemarketing needs to us, you can focus on your core business while we handle the critical task of building meaningful connections with your customers.</p>
                        </div>
                    </div>
                    <div class="ourstory__bottom">
                        <div class="ourstory__bottom-img-wrapper">
                            <img src="{{asset('resources/img/landingPage/Services/telemarketing.jpg')}}" alt="" loading="lazy">
                        </div>
                    </div>
                </div>
            </section>
        ...
        <section id="serviceFeatures" class="our-value">
            <div class="our-value__heading">
                <div class="our-value-heading-items">
                    ...
                    <h2>Nata Praja<br>Telemarketing<br>Service</h2>
                </div>
            </div>
            <div class="accordion">
                <div class="accordion-item active">
                    <div class="accordion-header" onclick="toggleAccordion(this)">
                        <h3>Key Features of Our Telemarketing Service</h3>
                        <span class="arrow"></span>
                    </div>
                    <div class="accordion-content">
                        <ol>
                            <li><strong>Lead Generation:</strong> Identifying and engaging potential customers to grow your sales pipeline.</li>
                            <li><strong>Market Expansion:</strong> Reaching out to new markets and demographics to promote your products or services.</li>
                            <li><strong>Customer Retention:</strong> Building loyalty by maintaining regular contact with existing customers.</li>
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <ol>
                            <li><strong>Expert Telemarketers:</strong> Our team consists of highly skilled professionals with experience in engaging diverse audiences effectively.</li>
                            <li><strong>Data-Driven Strategies:</strong> We utilize customer insights and analytics to design campaigns that deliver measurable results.</li>
                            <li><strong>Advanced Technology:</strong> Equipped with modern telecommunication tools, we ensure efficient and seamless interactions.</li>
                        </ol>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <ol>
                            <li><strong>Product and Service Promotion:</strong> Launch and promote new offerings to potential and existing customers.</li>
                            <li><strong>Customer Surveys:</strong> Collect insights and feedback to improve customer satisfaction.</li>
                            <li><strong>Appointment Setting:</strong> Schedule meetings or demos for your sales team with qualified leads.</li>
                            <li><strong>Upselling and Cross-Selling:</strong> Introduce additional products or services to existing customers to boost revenue.</li>
                        </ol>
                    </div>
                </div>
                <div class="accordion-item">
