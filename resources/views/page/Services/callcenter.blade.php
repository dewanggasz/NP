...
<body>
    ...
    <div class="breadcrumb">
        <div class="breadcrumb__wrapper">
            ...
            <div class="breadcrumb__icon2">></div>
            <div class="breadcrumb__info">
                <a href="{{route('callcenter')}}">Call Center</a>
            </div>
        </div>
     </div>
    <!-- breadcrumb -->
            ...
            <div class="page-cover__wrapper">
                ...
                <div class="page-cover__overlay">
                    ...
                    <a href="#serviceFeatures" class="page-cover__overlay-bot scroll-link">
                        <h2>Introduction to Call Center Service</h2>
            ...
            <section class="ourstory">
                <div class="ourstory__wrapper">
                    <div class="ourstory__top">
                        <div class="sub-title">Call Center</div>
                        <h2 class="ourstory-header">Empowering Businesses with Exceptional Call Center Services to Enhance Customer Experience and Build Long-Lasting Relationships</h2>
                        <div class="ourstory-paragraph">
                            <p>Our Call Center service serves as the vital communication bridge between your business and its customers, ensuring every interaction is handled with professionalism, efficiency, and care. Designed to enhance customer satisfaction, our call center agents are highly trained to respond promptly to inquiries, address concerns effectively, and provide accurate information about your products or services.</p>
                            <p>By leveraging advanced technology and customer-centric solutions, we aim to deliver seamless communication that strengthens your brand's reputation and fosters lasting customer relationships. With our commitment to excellence, we provide businesses with a reliable and scalable solution to manage customer interactions, improve service quality, and enhance operational efficiency. Let us help you transform every customer touchpoint into an opportunity to build trust and loyalty.</p>
                        </div>
                    </div>
        ...
        <section id="serviceFeatures" class="our-value">
            <div class="our-value__heading">
                <div class="our-value-heading-items">
                    ...
                    <h2>Nata Praja Call Center Service</h2>
                </div>
            </div>
            <div class="accordion">
                <div class="accordion-item active">
                    <div class="accordion-header" onclick="toggleAccordion(this)">
                        <h3>Key Features of Your Call Center</h3>
                        <span class="arrow"></span>
                    </div>
                    <div class="accordion-content">
                        <ol>
                            <li><strong>Inbound & Outbound Calls</strong>: Mengelola panggilan masuk dan keluar untuk berbagai kebutuhan pelanggan.</li>
                            <li><strong>Real-Time Dashboard</strong>: Pemantauan langsung untuk memastikan efisiensi dan kualitas layanan.</li>
                            <li><strong>Agent Script Development & IVR Scripting</strong>: Membantu membuat panduan interaksi yang konsisten dan personal untuk pelanggan.</li>
                            <li><strong>Voice Recording & Backup</strong>: Menjamin dokumentasi komunikasi untuk kualitas dan keamanan.</li>
                        </ol>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <ol>
                            <li><strong>Tim Profesional</strong>: Agen Call Center dilatih untuk merespons kebutuhan pelanggan secara efisien.</li>
                            <li><strong>Teknologi Canggih</strong>: Sistem telepon modern dengan fitur routing panggilan otomatis.</li>
                            <li><strong>Keamanan Data</strong>: Sesuai standar ISO 27001:2013, memastikan data pelanggan aman.</li>
                        </ol>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <ol>
                            <li><strong>Customer Support</strong>: Membantu pelanggan menyelesaikan masalah atau mendapatkan informasi dengan cepat.</li>
                            <li><strong>Survei Kepuasan Pelanggan</strong>: Mengumpulkan feedback untuk meningkatkan layanan.</li>
                            <li><strong>Kampanye Pemasaran</strong>: Meningkatkan penjualan melalui telemarketing yang ramah dan profesional.</li>
                            <li><strong>Penanganan Keluhan</strong>: Memastikan semua keluhan ditangani dengan baik untuk menjaga loyalitas pelanggan.</li>
                        </ol>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <ol>
                            <li>Meningkatkan kepuasan pelanggan melalui layanan yang responsif dan personal.</li>
                            <li>Membantu perusahaan klien fokus pada pengembangan inti bisnis mereka.</li>
                            <li>Mengurangi risiko reputasi dengan penanganan pelanggan yang profesional.</li>
                        </ol>
                    </div>
                </div>
            </div>
