...
<body>
    ...
    <header id="#header" class="header">
        ...
        <nav class="navmobile">
            <div class="navbig-left logo-medium">
                <a href="/index.html"><img src="{{ asset('resources/img/LOGO NPS GREEN.png') }}" alt="NPS Logo" class="logo" id="logoMobile2"></a> 
            </div>
                    ...
                    @foreach ($articles as $article)
                        <a href="{{ route('artikel.show', ['slug' => $article->slug]) }}" class="article-card2">
                            ...
                            <div class="article-card2-content">
                                ...
                                <p class="article-card2-caption">{{ Str::limit(strip_tags($article->body), 200) }}</p>
                            </div>
                        </a>
                    @endforeach
                </div>
